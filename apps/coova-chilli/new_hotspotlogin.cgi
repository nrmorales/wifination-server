...
<html lang="en">
   <head>
      <title>WiFi Nation Login</title>
      <link rel='stylesheet' href='static/css/bootstrap.min.css'>
      <link rel='stylesheet' href='static/css/social-buttons.css'>
      <link rel='stylesheet' href='static/css/font-awesome.min.css'>
      <link rel='stylesheet' href='static/css/wifination.min.css'>
...
<body onLoad=\"javascript:doOnLoad($result, '$loginpath?res=popup2&uamip=$data{'uamip'}&uamport=$data{'uamport'}&userurl=".&urlencode($data{'userurl'})."&redirurl=".&urlencode($data{'redirurl'})."&timeleft=$timeleft','$data{'userurl'}', '$data{'redirurl'}', '$timeleft')\" onBlur = \"javascript:doOnBlur($result)\">
